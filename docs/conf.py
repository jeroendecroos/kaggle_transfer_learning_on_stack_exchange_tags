# -*- coding: utf-8 -*-
#
# kaggle_transfer_learning_on_stack_exchange_tags documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'kaggle_transfer_learning_on_stack_exchange_tagsdoc'
